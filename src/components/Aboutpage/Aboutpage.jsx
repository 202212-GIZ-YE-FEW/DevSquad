            ...
            <div className='relative'>
                ...
                <div className='absolute top-0 left-0 right-0 bottom-0'>
                    <div className='flex h-full w-full flex-col items-center justify-center'>
                        ...
                        <p className='text-md mr-12 ml-12 font-Rubik text-center md:ml-24 md:mr-24 md:text-2xl lg:ml-32 lg:mr-32 lg:text-2xl'>
                            Pebble is a place where you can find and start local
                            movements and gatherings to support one or more of
                            the 17 Sustainable Development Goals. We bring
                            determined people together to make the world a
                            better place. Our growing community makes us more
                            passionate about what we do.
                        </p>
                    </div>
                </div>
            </div>
            <div className='m-10 min-h-[320px] overflow-hidden rounded-3xl bg-[#fef1e6] md:m-30 md:min-h-[900px] lg:m-44'>
                <h2 className='p-4 text-center font-Rubik text-2xl font-medium md:p-8 md:text-4xl md:font-bold lg:p-12 lg:text-5xl lg:font-bold'>
                    Our Team
                </h2>
