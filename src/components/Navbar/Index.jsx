                    ...
                    <div>
                        <div className='flex items-center justify-between py-3 md:py-5 md:block'>
                            ...
                            <svg
                                ...
                                fill='none'
                                xmlns='http://www.w3.org/2000/svg'
                                className='sm:w-52 sm:h-16 w-24 h-8'
                            >
                                <path
                    ...
                    <div>
                        ...
                        >
                            <ul className='items-center justify-center  md:flex md:space-x-6 md:space-y-0 '>
                                ...
                                <li className='text-white flex  p-4 align-items-center gap-2 bg-primary-orange'>
                                    <svg
                                        width='28'
                                        height='28'
                                        viewBox='0 0 28 28'
                        ...
                        >
                            <ul className='items-center justify-center  md:flex md:space-x-6 md:space-y-0 sm:z-10'>
                                ...
                                <li className='text-white flex align-items-center gap-2 bg-primary-orange px-4 py-2 text-lg'>
                                    <svg
                                        width='28'
                                        height='28'
                                        viewBox='0 0 28 28'
                        ...
                        {/* <div class='relative ml-3 md:hidden'>
                            <div
                                class={`absolute right-0 z-10 mt-2 w-48 origin-top-right d bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none border border-black ${
                            ...
                            >
                                ...
                                <Link
                                    href='#'
                                    class='block px-4 py-2 text-lg text-white bg-primary-orange border-b-2'
                                >
                                    Sign out
                                </Link>
                            </div>
